This repo creates a posgreSQL table based on Los Angeles County's CAMS dataset, addresses in the City of L.A., and parcel data.

It is assumed you have the following layers as tables already loaded in your PostGIS database. Here are some downloads:
